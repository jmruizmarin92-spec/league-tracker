                ...
                <ul className="flex flex-col divide-y">
                  {players.map((p) => (
                    <PlayerQuickEditRow
                      key={p.id}
                      player={p}
                      quickEditAction={updatePlayerQuickIdsAction}
                      deleteAction={deletePlayerAction}
                      labels={{
                        badgeLinked: t("badgeLinked"),
                        badgeManaged: t("badgeManaged"),
                        ...
                        edit: t("edit"),
                        delete: t("delete"),
                        confirmDelete: t("confirmDeletePlayer", {
                          name: p.display_name,
                        }),
                      }}
                    />
